# =============================================================================
# AFRICA RESQ - Emergency Shelter Dataset (Egypt)
#
# Real evacuation / gathering points in the most populated Egyptian cities.
# These are public landmarks, stadiums, parks and civic squares that can be
# used as emergency shelters on the live dashboard.
#
# Prototype dataset - capacity values are estimates.
# =============================================================================
...
# Cities available on the dashboard
CITIES = sorted(
    {
        shelter["city"]
